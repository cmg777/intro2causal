...
**The data:** Economists Stacy Dale and Alan Krueger used the **College and Beyond (C&B)** dataset, which tracked over 14,000 students from the 1976 college-entering cohort. The data includes the colleges each student applied to, where they were admitted, where they enrolled, their SAT scores, parental income, and their earnings in 1995 (about 19 years after college entry). Colleges are classified by Barron's selectivity rating (Most Competitive, Highly Competitive, Competitive, etc.).
