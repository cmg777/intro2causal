---
title: "Chapter 4: Regression Discontinuity"
...
for var, label in outcomes.items():
    ...
    r2 = pf.feols(f"{var} ~ over21 + age + age2 + over_age + over_age2", data=mlda, vcov="hetero")
    ...
    r4 = pf.feols(f"{var} ~ over21 + age + age2 + over_age + over_age2", data=narrow, vcov="hetero")
