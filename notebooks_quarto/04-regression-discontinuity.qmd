...
4. **Sharp vs. fuzzy**: A city implements a rule that buildings over 50 years old receive historic preservation status, which restricts renovations. In practice, some old buildings are exempted and some newer buildings apply for status voluntarily. (a) Is this sharp or fuzzy RD? (b) How would you estimate the effect of preservation status on property values?
:::
